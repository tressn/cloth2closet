...
export default async function CustomerProfilePage() {
  ...
  const [user, customerProfile, measurements, saved, reviews, quotes, files] =
    await Promise.all([
      ...
      prisma.review.findMany({
        ...
        include: {
          project: {
            select: { id: true, projectCode: true, dressmaker: { select: { id: true, name: true, username: true } } },
          },
        },
      }),
  ...
  return (
    <Page title="My Profile">
      <div className="grid gap-6">
        ...
        <Card>
          {/* Reuse your existing measurements UX, but show quick summary here */}
          <div className="p-6">
            <h2 className="text-xl font-semibold">Measurements</h2>
            <p className="mt-2 text-sm opacity-80">
              Latest set: {latestMeasurement ? new Date(latestMeasurement.updatedAt).toLocaleString() : "None yet"}
            </p>
